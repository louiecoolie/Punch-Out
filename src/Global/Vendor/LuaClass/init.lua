--[[
===========================================================
	Discordia's Lua class system:
		https://github.com/SinisterRectus/Discordia/

	Changes:
		- support for abstract classes
		- support for singleton classes
		- null reference for setting nil values
		- luau increment operators
===========================================================
]]

-- nullRef to act as an object to treat as a nil value when loading in data
local nullRef = {}
...
function meta:__call(...)
	assert(self.__init, "'__init' Instantiator is not defined for class: '"..self.__name.."'")
	local obj = self.__init(self, ...)
